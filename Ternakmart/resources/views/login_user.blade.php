...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <div class="max-w-md mx-auto mt-10">
        <form method="POST" action="{{ route('login-user') }}" class="bg-white p-6 rounded shadow">
            @csrf
            ...
            <p class="text-center text-gray-500 mt-4">
                Belum punya akun? <a href="{{ route('register-user') }}" class="text-blue-500">Daftar di sini</a>.
            </p>
        </form>
    </div>
